...
CREATE TABLE `track`(
    ...
    CONSTRAINT `album` FOREIGN KEY (`album`) REFERENCES `sql12618343`.`album` (`album_id`) ON UPDATE CASCADE ON DELETE CASCADE,
    CONSTRAINT `singer` FOREIGN KEY (`singer`) REFERENCES `sql12618343`.`singer` (`singer_id`) ON UPDATE CASCADE ON DELETE CASCADE
);
